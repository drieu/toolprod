...
<div class="container">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title">Import des fichiers de crontab</h3>
        </div>
        <div class="panel-body">
            ...
            <g:uploadForm action="initCrontab" controller="admin">

                <form role="form">
                    <div class="form-group">
                        <label for="files">Choix du fichier à parser</label>
                        <input type="file" id="files" name="files[]" multiple>
                        <p class="help-block">Vous devez choisir un fichier de crontab unix</p>
                    </div>
                    <div class="form-group">
                        <label for="machinename">Nom de la machine sur lequel se trouve la crontab</label>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-hover table-striped">
                ...
                <g:each in="${toolprod.Crontab.findAll()}" var="cron">
                    <g:if test="${cron != null}" >
                        <tr>
                            <td>${cron?.crontab}</td>
                            <td>${cron?.command}</td>
